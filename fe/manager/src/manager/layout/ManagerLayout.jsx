...
const links = [
  { to: '/manager', end: true, icon: '▦', label: 'Tổng quan' },
  { to: '/manager/properties', icon: '⌂', label: 'Chỗ nghỉ' },
  { to: '/manager/calendar', icon: '▤', label: 'Giá và tồn phòng' },
  { to: '/manager/bookings', icon: '✓', label: 'Booking' },
]
    ...
    <div className="manager-shell">
      <aside className="manager-sidebar">
        <div className="manager-sidebar-brand">
          ...
          <small>Kênh HOTEL_MANAGER · 5174</small>
        </div>
